...
from zad4.api import signal_zad4, signal_conversion
...
class zad3Frame:
    ...
    def execute_convolution(self):
        ...
        self.y_values = signal_zad4.convolution(y1, y2)
    ...
    def execute_filtration(self):
        ...
        self.y_values = signal_zad4.convolution(self.y_values, filter_y_values)
        #self.t_values = np.linspace(self.s1Frame.t_values[0], self.s1Frame.t_values[-1], len(self.y_values))
